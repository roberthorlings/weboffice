...
Route::group ( [ 
	...
	Route::post ( '/daterange', [ 
			'uses' => 'DashboardController@dateRange',
			'as' => 'daterange' 
	] );
	...
	// Specific statements
	Route::get ( 'statement/create/incoming-invoice', [ 
			'as' => 'statement.incoming-invoice',
			'uses' => 'StatementController@incomingInvoice' 
	] );
	Route::post ( 'statement/create/incoming-invoice', [ 
			'as' => 'statement.book-incoming-invoice',
			'uses' => 'StatementController@bookIncomingInvoice' 
	] );
	Route::get ( 'statement/create/cost-declaration', [ 
			'as' => 'statement.cost-declaration',
			'uses' => 'StatementController@costDeclaration' 
	] );
	Route::post ( 'statement/create/cost-declaration', [ 
			'as' => 'statement.book-cost-declaration',
			'uses' => 'StatementController@bookCostDeclaration' 
	] );
	...
	Route::get ( 'vat', [ 
			'as' => 'vat.index',
			'uses' => 'VATController@index' 
	] );
	Route::post ( 'vat', [ 
			'as' => 'vat.book',
			'uses' => 'VATController@book' 
	] );
	...
	Route::get ( 'export/year/{year?}', [ 
			'as' => 'export.year',
			'uses' => 'ExportController@year' 
	] );
	...
	Route::post ( 'invoice/{id}/statement', [ 
			'as' => 'invoice.statement',
			'uses' => 'InvoiceController@bookStatement' 
	] );
	
	Route::get ( 'quote/{id}/pdf', [ 
			'as' => 'quote.pdf',
			'uses' => 'QuoteController@pdf' 
	] );
	Route::post ( 'quote/{id}/mark_as_final', [ 
			'as' => 'quote.mark_as_final',
			'uses' => 'QuoteController@markAsFinal' 
	] );
	
	// Store configuration
	Route::post ( 'configuration/saveConfiguration', [ 
			'as' => 'configuration.saveConfiguration',
			'uses' => 'ConfigurationController@saveAll' 
	] );
	
	// Extra actions for posts
	Route::post ( 'post/rebuild', [ 
			'as' => 'post.rebuild',
			'uses' => 'PostController@rebuild' 
	] );
	Route::post ( 'post/{id}/moveUp', [ 
			'as' => 'post.moveUp',
			'uses' => 'PostController@moveUp' 
	] );
	Route::post ( 'post/{id}/moveDown', [ 
			'as' => 'post.moveDown',
			'uses' => 'PostController@moveDown' 
	] );
	
	Route::get ( 'travelexpense/pdf', [ 
			'as' => 'travelexpense.pdf',
			'uses' => 'TravelExpenseController@pdf' 
	] );
	Route::post ( 'travelexpense/statement', [ 
			'as' => 'travelexpense.statement',
			'uses' => 'TravelExpenseController@bookStatement' 
	] );
