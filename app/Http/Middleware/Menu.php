...
class Menu
{
    ...
    public function handle($request, Closure $next)
    {
    	\Menu::make('MainMenu', function($menu){
    		...
    		$finances = $menu->add('Finances', [ 'icon' => 'fa-eur' ]);
			...
			$documents = $menu->add('Documents', [ 'icon' => 'fa-file-text-o' ]);
				...
				$documents_more = $documents->add('More');
					...
					$documents_more->add('Receive invoice', [ 'url' => 'statement/receive_invoice', 'icon' => 'fa-eur' ]);
					$documents_more->add('Report costs', [ 'url' => 'statement/report_costs', 'icon' => 'fa-eur' ]);
						
			$crm = $menu->add('CRM', [ 'icon' => 'fa-file-text-o' ]);
			...
			$other = $menu->add('Other', [ 'icon' => 'fa-ellipsis-v' ]);
