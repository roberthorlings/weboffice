            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
			        <table class="table table-bordered table-striped table-hover">
			            <thead>
			                <tr>
			                    <th>Datum</th><th>Omschrijving</th><th>Opmerkingen</th><th>Actions</th>
			                </tr>
			            </thead>
			            <tbody>
			            @foreach($statement as $item)
			                <tr>
			                    <td><a href="{{ url('statement', $item->id) }}">{{ $item->datum }}</a></td><td>{{ $item->omschrijving }}</td><td>{{ $item->opmerkingen }}</td>
			                    <td>
			                        {!! Form::open([
			                            'method'=>'DELETE',
