...
@endsection
 @section('page_title', "Incoming invoice")
 
@section('content') 
{!! Form::open([ 
	'method' => 'POST', 
	'url' => route('statement.book-incoming-invoice'), 
				...
				<div class="box box-primary">
				  ...
				  <div class="box-body">
			            ...
			            <div class="form-group {{ $errors->has('factuurnummer') ? 'has-error' : ''}}">
			                {!! Form::label('titel', 'Factuurnummer: ', ['class' => 'col-sm-3 control-label']) !!}
			                <div class="col-sm-9">
			            ...
			            <div class="form-group {{ $errors->has('titel') ? 'has-error' : ''}}">
			                {!! Form::label('opmerkingen', 'Titel: ', ['class' => 'col-sm-3 control-label']) !!}
			                <div class="col-sm-9">
			                    {!! Form::text('opmerkingen', null, ['class' => 'form-control']) !!}
			                    {!! $errors->first('opmerkingen', '<p class="help-block">:message</p>') !!}
			                </div>
			            </div>
					    <div class="form-group">
			                {!! Form::label('relation_id', 'Leverancier: ', ['class' => 'col-sm-3 control-label']) !!}
			                <div class="col-sm-9">
