    ...
    <div class='row'>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
			        <table class="table table-bordered table-striped table-hover">
			            <thead>
			                <tr>
			                    <th>Factuurnummer</th><th>Versie</th><th>Titel</th><th>Actions</th>
			                </tr>
			            </thead>
			            <tbody>
			            @foreach($invoice as $item)
			                <tr>
			                    <td><a href="{{ url('invoice', $item->id) }}">{{ $item->factuurnummer }}</a></td><td>{{ $item->versie }}</td><td>{{ $item->titel }}</td>
			                    <td>
			                        {!! Form::open([
			                            'method'=>'DELETE',
			                            'url' => ['invoice', $item->id],
                ...
                <div class="box-footer pagination-footer">
			        <div class="pull-right"> {!! $invoice->render() !!} </div>
                </div><!-- /.box-footer-->
            </div><!-- /.box -->
        </div><!-- /.col -->
        <div class='col-md-4 col-sm-12'>
            ...
            <div class="box">
                ...
                <div class="box-body">
                	<a href="{{ url('invoice/create') }}" class="btn btn-primary btn-sm">Add New Invoice</a><br /><br />
