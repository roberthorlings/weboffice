		...
		<div class="box">
		  ...
		  <div class="box-body">
			    ...
			    <div class="form-group {{ $errors->has('TravelExpense[van_naar]') ? 'has-error' : ''}}">
	                ...
	                <div class="col-sm-8">
	                    {!! Form::text('TravelExpense[van_naar]', null, ['class' => 'form-control', 'required' => 'required']) !!}
			    ...
			    <div class="form-group {{ $errors->has('TravelExpense[bezoekadres]') ? 'has-error' : ''}}">
	                ...
	                <div class="col-sm-8">
	                    {!! Form::textarea('TravelExpense[bezoekadres]', null, ['class' => 'form-control visiting-address', 'required' => 'required', 'data-self-url' => url('relation/self')]) !!}
			    ...
			    <div class="form-group {{ $errors->has('TravelExpense[afstand]') ? 'has-error' : ''}}">
	                ...
	                <div class="col-sm-8">
	                    {!! Form::text('TravelExpense[afstand]', null, ['class' => 'form-control travel-distance', 'required' => 'required']) !!}
			    ...
			    <div class="form-group {{ $errors->has('TravelExpense[km_begin]') ? 'has-error' : ''}}">
	                ...
	                <div class="col-sm-8">
	                    {!! Form::text('TravelExpense[km_begin]', null, ['class' => 'form-control travel-start', 'required' => 'required']) !!}
			    ...
			    <div class="form-group {{ $errors->has('TravelExpense[km_eind]') ? 'has-error' : ''}}">
	                ...
	                <div class="col-sm-8">
	                    {!! Form::text('TravelExpense[km_eind]', null, ['class' => 'form-control travel-end', 'required' => 'required']) !!}
